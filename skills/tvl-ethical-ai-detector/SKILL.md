...
Audit a draft or agent response before it is trusted. The detector is advisory: it returns evidence, failure-mode findings, and a verdict, but it does not rewrite the draft unless the user asks.
